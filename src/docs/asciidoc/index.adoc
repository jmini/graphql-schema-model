...
Publication to maven central is using https://jreleaser.org/[jreleaser], following properties are expected to be set (for example in `~/.jreleaser/config.toml` or as environment variables):
